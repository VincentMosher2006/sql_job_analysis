/* 
    Questions: What skills are required for the top-paying data scientist jobs?
    - Use the top 10 highest-paying Data Science jobs from first query
    - Add the specific sills required for these roles 
    - Why? It provides a detailed look at which high-paying jobs demand certain skills, helping job seekers understand which skills to develop that allign with top salaries  
*/
...
/* Here is the breakdown of the most demanded skills for data scietntists in 2023, based on job postings:
Python and SQL are tied with a count of 4. 
Java is next with a count of 3. 
Other skills listed are AWS, tensorflow, pytorch, Pandas, etc.
